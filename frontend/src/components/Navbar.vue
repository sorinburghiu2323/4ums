<template>
    <div id="nav">
        <router-link class="nav-link" to="../homepage" v-on:click = "goTo('homepage')">
            <div id="homepage" v-on:click="goTo('homepage')">
                <font-awesome-icon :icon="['fas', 'home']" />
                <p class="icon">Feed</p>
            </div>
        </router-link>
        <router-link class="nav-link" to="../../../communities" v-on:click = "goTo('communities')">
        ...
        <router-link class="nav-link" to="../leaderboard" v-on:click = "goTo('leaderboard')">
